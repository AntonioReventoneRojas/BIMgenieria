# -*- coding: utf-8 -*-
__title__= "Lamina de\nPiezas" #Name of the button displayed in Revit UI
__doc__= """ Calcula el área de lámina de todos las piezas 
de ductos como codos, reducciones, transiciones.
Son descontadas las áreas de los conectores. 

La herramienta tiene dos modos de uso:
1 - Por medio de una selección 
2 - Selecciona todos las piezas de ducto del modelo

Para evitar crasheos en proyectos con gran 
cantidad de piezas la opcción 1 está asignada
